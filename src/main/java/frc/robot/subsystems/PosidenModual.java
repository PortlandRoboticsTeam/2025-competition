...
public class PosidenModual extends SubsystemBase{
    ...
    public double getTurnPosition() {
        return getAbsoluteEncoderRadians();
    }

    public double getDriveVelocity() {
        return driveMotor.getRotorVelocity().getValueAsDouble()*360;
    }

    public double getTurnVelocity() {
        return absoluteEncoder.getVelocity().getValueAsDouble()*360;
    }

    public double getAbsoluteEncoderRadians() {
        Rotation2d v = Rotation2d.fromDegrees(absoluteEncoder.getAbsolutePosition().getValueAsDouble()*360);
    ...
    //Sets the speed for the turn motor, idk why it's called "DesiredState"
     public void setDesiredState(SwerveModuleState state) {
        ...
        SmartDashboard.putNumber("module "+swervePodId+" current output",turnOutput );
    ...
    public void periodic(){
        SmartDashboard.putNumber("module "+swervePodId+" position:", getAbsoluteEncoderDegrees());
        SmartDashboard.putNumber("module "+swervePodId+" current Setpoint",lastAngle.getDegrees() );
        SmartDashboard.putNumber("module "+swervePodId+" current error",lastAngle.getDegrees()-getAbsoluteEncoderDegrees() );
    }
}