...
public class PosidonDrive extends Command{
  
  private final PosidonSwerve swerve;
  private DoubleSupplier x, y, z; 
  private double xOutput, yOutput, zOutput;
  private boolean isAuton;
  private DoubleSupplier driveInversionMultiplier = ()->1;
  private DoubleSupplier visionOffset = ()->0;
  ...
  public PosidonDrive(PosidonSwerve swerve, DoubleSupplier x, DoubleSupplier y, DoubleSupplier z, boolean isAuton) {
    this.swerve = swerve;
    this.x = x;
    this.y = y;
    this.z = z;
