...
public class drive extends Command
{
   ...
   */
  public drive(SwerveSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingAdjust,
  ...
  public void execute()
  {
    ...
    {
      resetHeading = true;
      swerve.drive(translation, (Constants.TURN_CONSTANT * -headingAdjust.getAsDouble()), true);
    } else
    {
